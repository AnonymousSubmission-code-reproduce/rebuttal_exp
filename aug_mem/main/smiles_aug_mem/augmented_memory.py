...
class ExperienceReplay:
    ...
    def augmented_memory_replay(self, args, mol_lm):
        ...
        if len(self.buffer) > 0:
            ...
            randomized_smiles_list = get_randomized_smiles(args.oracles[0], args.mol_lm, mol_lm, args.bin_size, smiles, self.prior)
